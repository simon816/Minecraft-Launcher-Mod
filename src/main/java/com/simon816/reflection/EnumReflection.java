...
/**
 * This is not mine! Found originally here: http://niceideas.ch/roller2/badtrash/entry/java_create_enum_instances_dynamically
 */
public class EnumReflection {
    ...
    public static <T extends Enum<?>> void addEnum(Class<T> enumType, String enumName, Object... parameters) {
        ...
        try {
            ...
            for (int i = 0; i < parameters.length; i++) {
                parClasses[i] = parameters[i].getClass();
                parValues[i] = parameters[i];
            }
            T newValue = (T) makeEnum(enumType, // The target enum class
                    enumName, // THE NEW ENUM INSTANCE TO BE DYNAMICALLY ADDED
                    values.size(), parClasses, parValues);
